export async function onRequestGet(context) {
    ...
    try {
        ...
        const query = `
            SELECT u.id, u.email, u.name, u.picture, COALESCE(u.picture, u.avatar_url) as avatar_url, u.bio, u.username, u.is_profile_completed, u.status, u.banned_until, u.verified, u.category, u.dm_privacy, u.created_at, (SELECT COUNT(*) FROM posts WHERE user_id = u.id) as posts_count
            FROM users u
